...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body bgcolor="#DA2A2A" style="background-color: #DA2A2A">		        	                   
        ...
        <table bgcolor="#DA2A2A" width="100%" border="0" cellpadding="0" cellspacing="0" style="background: #DA2A2A; padding: 0px; margin: 0px; border-collapse: collapse;">             
                                        ...
                                        <td align="center" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin: 0px; border-collapse: collapse;"> 
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                                ...
                                                <tr> 
                                                    ...
                                                    <td class="fullwidthcontenttableinset" bgcolor="#DA2A2A" width="600" align="center" valign="top" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                        ...
                                        <td align="center" bgcolor="#ffffff" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin: 0px; border-collapse: collapse;"> 
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                                ...
                                                <tr> 
                                                    ...
                                                    <td class="fullwidthcontenttableinset" width="600" align="center" style="font-size: 0px; line-height: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin: 0px; border-collapse: collapse; max-width: 600px; max-height: 137px;"> 

                                                        <!--Logo 276 goes here--><img class="img-600" src="<?php echo base_url();?>resources/img/template/an-mailheader.png" width="600" alt="header" border="no" style="margin: 0px; padding: 0px; border: none; max-width: 600px; max-height: 137px;"/> 
                                                    ...
                                                    <!--START CONTENT column-->
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px; border-collapse: collapse;">                                                                             
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                <td class="title-text" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; line-height: 20px; padding-top: 0px; padding-right: 15px; padding-bottom: 0px; padding-left: 15px; margin: 0px; border-collapse: collapse;"> 

                                                                                <p>&nbsp;</p>


<p>Hi,</p>
<strong><?php echo $firstname;?> <?php echo $lastname;?></strong><br><br>
<p>This e-mail is from <a href="<?php echo base_url();?>"><?php echo base_url();?></p>
<p>To reset your password please click on the button given below.</p>
<div style="text-align: center;margin-top:20px;">
<a href="<?php echo $link;?>" style="background-color:#DA2A2A;color:#fff;padding: 10px;">Click here to reset password</a>
</div>
<br />
                                                    ...
                                                    <td class="fullwidthcontenttableinset" width="600" align="center" valign="top" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                                            ...
                                                            <tr> 
                                                                ...
                                                                <td bgcolor="#ffffff" align="center" height="10" style="padding: 0px; margin: 0px; border-collapse: collapse;"></td> 
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px; border-collapse: collapse;"> 
                                                                        ...
                                                                        <tr> 
                                                                            ...
                                                                            <td class="fullwidthcontenttableinset" width="600" align="center" style="font-size: 0px; line-height: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin: 0px; border-collapse: collapse; max-width: 600px; max-height: 137px;"> 
                                                                                ...
                                                                                <!--Logo 276 goes here--><img class="img-600" src="<?php echo base_url();?>resources/img/template/an-mailfooter.png" width="600" alt="footer" border="no" style="margin: 0px; padding: 0px; border: none; max-width: 600px; max-height: 137px;"/> 
